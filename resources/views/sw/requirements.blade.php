  ...
  <div class="row">
    ...
    <div class="col-md-5"style="text-align: left">
      ...
      <div class="card-header">
       <h6><i class="fas fa-dollar-sign"></i> Application or Admission Requirements</h6>
       </div>
       <div class="card-body">
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
           <li class="nav-item"><a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="false" style="color: darkblue;"> <i class="fas fa-dollar-sign"></i> Application or Admission Requirements for Bachelor Programmes 2019/2020  </a>
          </li>        
          <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false" style="color: darkblue;"><i class="fas fa-dollar-sign"></i> Application or Admission Requirements for Ordinary Diploma Programmes 2019/2020 </a>  
         </li>
          <li class="nav-item">
            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false" style="color: darkblue;"><i class="fas fa-dollar-sign"></i>Application or Admission Requirements for Certificate Programmes 2019/2020
            </a> 
          </li>
            <br>
            <br>
