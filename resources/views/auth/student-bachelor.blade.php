...
@section('student-content')
  ...
  <div class="row" style="color:#31708f">
        <div class="col-md-8 col-sm-10 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2><i class='fa fa-file'></i> Bachelor Books & Materials <small>Custom design</small></h2>
                  ...
                  <div class="clearfix"></div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                        @foreach($bachelor as $bachelor)
                          <tr class="even pointer">
                            <td class="a-center ">
                              <input type="checkbox" class="flat" name="table_records">
                            </td>
                          
                            <td>{{$bachelor->filename}}</td>
                            <td>{{$bachelor->course}}</td>
                            <td>{{$bachelor->education_level}}</td>
                            <td class=" last"> 
