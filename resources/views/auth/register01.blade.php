            ...
            <div class="login_wrapper">
                <div class="animate form login_form">
                    <section class="login_content">
                        ...
                        <div class="card-body">  
                        <h4>Student Signup Disabled</h4>
                        <br>

                         @isset($url)
            <form method="POST" action='{{ url("register/$url") }}' arial-label="{{_('Register')}}">
                         @else
            <form method="POST" action="{{ route('register') }}" arial-label= "{{_('Register')}}">   
                         @endisset
                         ...
                         @csrf
                          ...
                          <div class="form-group row ">
                                <div class="col-md-5 ">
                                    <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" placeholder="Student User ID" name="id" maxlength="5" value="{{ old('id') }}" required autocomplete="id" autofocus>
                           ...
                           <div class="form-group row ">
                            <div class="col-md-5 ">
                                    ...
                                    <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" placeholder="Education Level(Kisw)" name="first_name" value="{{ old('first_name') }}" required autocomplete="first_name" autofocus>
                            ...
                            <div class="col-md-5">
                                    ...
                                    <input id="middle_name" type="text" class="form-control @error('middle_name') is-invalid @enderror" placeholder="Education Level(Engl)" name="middle_name" value="{{ old('middle_name') }}" required autocomplete="middle_name" autofocus>
