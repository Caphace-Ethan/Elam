            ...
            <div class="login_wrapper">
                <div class="animate form login_form">
                    <section class="login_content">
                        ...
                        <h2> <img src="images/echaseLogo.png" width="60px" alt="ECHASE" style="border-radius:40px "> EOMS </h2>
                        </div>
                        <div class="card-body">  
             <h5 > EOMS Student Login </h5>

                   <br>
                        @isset($url)
                    <form method="POST" action='{{ url("login/$url") }}' arial-label="{{_('Login')}}">
                         @else
                    <form method="POST" action="{{ route('login') }}" arial-label= "{{_('Login')}}">   
                         @endisset
                            @csrf
