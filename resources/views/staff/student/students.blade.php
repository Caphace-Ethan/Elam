...
<div class="row tile_count"style="color:#31708f">
  ...
  <h4><i class='fa fa-cogs'></i> Welcome To Students Management System.
    <br>&nbsp;&nbsp;&nbsp;&nbsp; </h4>
  </div>
</div>
...
<div class="row" style="color:#31708f">
         ...
         <div class="col-md-8 col-sm-9 col-xs-12">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 form-group pull-right top_search">
                 ...
                 <br>
        <h4> <a href="/#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <button type="button" class="btn btn-primary btn-sm"><i class='fa fa-cloud-upload'></i> Register Student</button></a> 
        </h4>
