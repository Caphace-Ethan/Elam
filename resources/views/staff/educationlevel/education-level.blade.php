...
<div class="row tile_count"style="color:#31708f">
  ...
  <h4><i class='fa fa-cogs'></i> Welcome To Education Levels Management System.
    <br>&nbsp;&nbsp;&nbsp;&nbsp; </h4>
  </div>
</div> 
    ...
    <div class="row" style="color:#31708f">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2><i class='fa fa-file'></i> Levels of Educations Offered at ECHASE </h2>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="clearfix"></div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Level ID </th>
                            <th class="column-title">Level Name </th>
                            <th class="column-title">Level Code </th>
                        ...
                        <tbody>
                        @foreach($educationlevel as $educationlevel)
                          <tr class="even pointer">
                            <td class="a-center ">
                              <input type="checkbox" class="flat" name="table_records">
                            </td>
                            <td>{{$educationlevel->id}}</td>
                            <td>{{$educationlevel->educationlevel_name}}</td>
                            <td>{{$educationlevel->educationlevel_code}}</td>
                            <td class=" last"> 
                   ...
                   <br>
        <h4> <a href="/#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <button type="button" class="btn btn-primary btn-sm"><i class='fa fa-cloud-upload'></i> Add Ed.Level</button></a> 
        </h4>
