   ...
   @if (session('status'))
    ...
    <div class="row" style="color:#31708f">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2><i class='fa fa-file'></i> Courses For Certificates, Diploma & Bachelor</h2>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 form-group pull-right top_search">
                  ...
                  <div class="clearfix"></div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title no-link"><span class="nobr">View</span>
                            </th>
                        ...
                        @foreach($course as $course)
                          <tr class="even pointer">
                            ...
                            <td>{{$course->educationlevel_id}}</td>
                            <td> 
                   ...
                   <br>
        <h4> <a href="/courses/create">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <button type="button" class="btn btn-primary btn-sm"><i class='fa fa-cloud-upload'></i> Register Course</button></a> 
        </h4>
